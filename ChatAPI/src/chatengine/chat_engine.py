...
class ChatEngine:
    ...
    def query(
        ...
        temperature=1.0,  # A high value (e.g., 1.0) makes the model more random and creative
        # Controls diversity of the response
        top_p=0.9,  # A high value (e.g., 0.9) allows for more diversity
        ...
        result = self.chain.invoke(
            input={"input_documents": input_documents, "question": query},
