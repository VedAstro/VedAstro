...
TEXT_QA_SYSTEM_PROMPT = ChatMessage(
    content=(
        "Answer question for easy understanding. Context is my life description.\n"
        ...
        "'However, it's important to consider ...' or "
        "'However, it's important to note ...' or anything along "
        "those lines."
    ),
