...
class SimpleAstrologyBookReader(BasePydanticReader):
    """Simple astrology book reader reader.
    ...
    def load_data(self, book_name: str) -> List[Document]:
        ...
        book_docs = SimpleDirectoryReader(input_files=[f"./pdf_store/{book_name}.pdf"]).load_data()
