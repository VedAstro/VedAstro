...
namespace LLMCallExperimenter
{
    internal class Program
    {
        ...
        static async Task<string> SendMessageToLLM(HttpClient client, List<string> conversationHistory)
        {
            var messages = new List<object>
            {
                new { role = "system", content = "ai assistant helper" }
            };
            ...
            Console.WriteLine(fullReply.Created);
            return replyMessage;
        }
