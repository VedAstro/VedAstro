...
namespace VedAstro.Library
{
    public class Prastaraka : IToJson
    {
        ...
        public Prastaraka(PlanetName inputPlanet)
        {
            MainPlanet = inputPlanet;
        }

        public PlanetName MainPlanet { get; set; }
        ...
        /// </summary>
        public Dictionary<ZodiacName, int> Bhinnashtaka()
        {
            //prepare empty row
        ...
        public JToken ToJson()
        {
            ...
            var bhinnashtakaRowData = this.Bhinnashtaka();
