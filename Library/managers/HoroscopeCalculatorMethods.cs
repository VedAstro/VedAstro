...
namespace VedAstro.Library
{
    ...
    public class HoroscopeCalculatorMethods
    {
        ...
        public static CalculatorResult AriesRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Aries, time), new[] { HouseName.House1, }, new[] { ZodiacName.Aries }, time);

        [HoroscopeCalculator(HoroscopeName.TaurusRising)]
        public static CalculatorResult TaurusRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Taurus, time), new[] { HouseName.House1, }, new[] { ZodiacName.Taurus }, time);

        [HoroscopeCalculator(HoroscopeName.GeminiRising)]
        public static CalculatorResult GeminiRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Gemini, time), new[] { HouseName.House1, }, new[] { ZodiacName.Gemini }, time);

        [HoroscopeCalculator(HoroscopeName.CancerRising)]
        public static CalculatorResult CancerRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Cancer, time), new[] { HouseName.House1, }, new[] { ZodiacName.Cancer }, time);

        [HoroscopeCalculator(HoroscopeName.LeoRising)]
        public static CalculatorResult LeoRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Leo, time), new[] { HouseName.House1, }, new[] { ZodiacName.Leo }, time);

        [HoroscopeCalculator(HoroscopeName.VirgoRising)]
        public static CalculatorResult VirgoRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Virgo, time), new[] { HouseName.House1, }, new[] { ZodiacName.Virgo }, time);

        [HoroscopeCalculator(HoroscopeName.LibraRising)]
        public static CalculatorResult LibraRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Libra, time), new[] { HouseName.House1, }, new[] { ZodiacName.Libra }, time);

        [HoroscopeCalculator(HoroscopeName.ScorpioRising)]
        public static CalculatorResult ScorpioRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Scorpio, time), new[] { HouseName.House1, }, new[] { ZodiacName.Scorpio }, time);

        [HoroscopeCalculator(HoroscopeName.SagittariusRising)]
        public static CalculatorResult SagittariusRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Sagittarius, time), new[] { HouseName.House1, }, new[] { ZodiacName.Sagittarius }, time);

        [HoroscopeCalculator(HoroscopeName.CapricornusRising)]
        public static CalculatorResult CapricornusRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Capricornus, time), new[] { HouseName.House1, }, new[] { ZodiacName.Capricornus }, time);

        [HoroscopeCalculator(HoroscopeName.AquariusRising)]
        public static CalculatorResult AquariusRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Aquarius, time), new[] { HouseName.House1, }, new[] { ZodiacName.Aquarius }, time);

        [HoroscopeCalculator(HoroscopeName.PiscesRising)]
        public static CalculatorResult PiscesRisingOccuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsHouseSignName(1, ZodiacName.Pisces, time), new[] { HouseName.House1, }, new[] { ZodiacName.Pisces }, time);
        ...
        public static CalculatorResult SunInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 1), new[] { HouseName.House1, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse1)]
        public static CalculatorResult MoonInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 1), new[] { HouseName.House1, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse1)]
        public static CalculatorResult MarsInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 1), new[] { HouseName.House1, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse1)]
        public static CalculatorResult MercuryInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 1), new[] { HouseName.House1, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse1)]
        public static CalculatorResult JupiterInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 1), new[] { HouseName.House1, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse1)]
        public static CalculatorResult VenusInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 1), new[] { HouseName.House1, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse1)]
        public static CalculatorResult SaturnInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 1), new[] { HouseName.House1, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse1)]
        public static CalculatorResult RahuInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 1), new[] { HouseName.House1, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse1)]
        public static CalculatorResult KetuInHouse1(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 1), new[] { HouseName.House1, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 2), new[] { HouseName.House2, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse2)]
        public static CalculatorResult MoonInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 2), new[] { HouseName.House2, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse2)]
        public static CalculatorResult MarsInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 2), new[] { HouseName.House2, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse2)]
        public static CalculatorResult MercuryInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 2), new[] { HouseName.House2, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse2)]
        public static CalculatorResult JupiterInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 2), new[] { HouseName.House2, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse2)]
        public static CalculatorResult VenusInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 2), new[] { HouseName.House2, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse2)]
        public static CalculatorResult SaturnInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 2), new[] { HouseName.House2, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse2)]
        public static CalculatorResult RahuInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 2), new[] { HouseName.House2, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse2)]
        public static CalculatorResult KetuInHouse2Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 2), new[] { HouseName.House2, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 3), new[] { HouseName.House3, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse3)]
        public static CalculatorResult MoonInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 3), new[] { HouseName.House3, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse3)]
        public static CalculatorResult MarsInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 3), new[] { HouseName.House3, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse3)]
        public static CalculatorResult MercuryInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 3), new[] { HouseName.House3, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse3)]
        public static CalculatorResult JupiterInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 3), new[] { HouseName.House3, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse3)]
        public static CalculatorResult VenusInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 3), new[] { HouseName.House3, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse3)]
        public static CalculatorResult SaturnInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 3), new[] { HouseName.House3, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse3)]
        public static CalculatorResult RahuInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 3), new[] { HouseName.House3, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse3)]
        public static CalculatorResult KetuInHouse3Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 3), new[] { HouseName.House3, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 4), new[] { HouseName.House4, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse4)]
        public static CalculatorResult MoonInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 4), new[] { HouseName.House4, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse4)]
        public static CalculatorResult MarsInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 4), new[] { HouseName.House4, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse4)]
        public static CalculatorResult MercuryInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 4), new[] { HouseName.House4, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse4)]
        public static CalculatorResult JupiterInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 4), new[] { HouseName.House4, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse4)]
        public static CalculatorResult VenusInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 4), new[] { HouseName.House4, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse4)]
        public static CalculatorResult SaturnInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 4), new[] { HouseName.House4, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse4)]
        public static CalculatorResult RahuInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 4), new[] { HouseName.House4, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse4)]
        public static CalculatorResult KetuInHouse4Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 4), new[] { HouseName.House4, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 5), new[] { HouseName.House5, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse5)]
        public static CalculatorResult MoonInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 5), new[] { HouseName.House5, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse5)]
        public static CalculatorResult MarsInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 5), new[] { HouseName.House5, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse5)]
        public static CalculatorResult MercuryInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 5), new[] { HouseName.House5, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse5)]
        public static CalculatorResult JupiterInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 5), new[] { HouseName.House5, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse5)]
        public static CalculatorResult VenusInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 5), new[] { HouseName.House5, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse5)]
        public static CalculatorResult SaturnInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 5), new[] { HouseName.House5, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse5)]
        public static CalculatorResult RahuInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 5), new[] { HouseName.House5, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse5)]
        public static CalculatorResult KetuInHouse5Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 5), new[] { HouseName.House5, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 6), new[] { HouseName.House6, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse6)]
        public static CalculatorResult MoonInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 6), new[] { HouseName.House6, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse6)]
        public static CalculatorResult MarsInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 6), new[] { HouseName.House6, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse6)]
        public static CalculatorResult MercuryInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 6), new[] { HouseName.House6, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse6)]
        public static CalculatorResult JupiterInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 6), new[] { HouseName.House6, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse6)]
        public static CalculatorResult VenusInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 6), new[] { HouseName.House6, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse6)]
        public static CalculatorResult SaturnInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 6), new[] { HouseName.House6, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse6)]
        public static CalculatorResult RahuInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 6), new[] { HouseName.House6, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse6)]
        public static CalculatorResult KetuInHouse6Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 6), new[] { HouseName.House6, }, new[] { PlanetName.Ketu }, time);


        //Planets in the 7th House

        [HoroscopeCalculator(HoroscopeName.SunInHouse7)]
        public static CalculatorResult SunInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 7), new[] { HouseName.House7, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse7)]
        public static CalculatorResult MoonInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 7), new[] { HouseName.House7, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse7)]
        public static CalculatorResult MarsInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 7), new[] { HouseName.House7, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse7)]
        public static CalculatorResult MercuryInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 7), new[] { HouseName.House7, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse7)]
        public static CalculatorResult JupiterInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 7), new[] { HouseName.House7, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse7)]
        public static CalculatorResult VenusInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 7), new[] { HouseName.House7, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse7)]
        public static CalculatorResult SaturnInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 7), new[] { HouseName.House7, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse7)]
        public static CalculatorResult RahuInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 7), new[] { HouseName.House7, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse7)]
        public static CalculatorResult KetuInHouse7Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 7), new[] { HouseName.House7, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 8), new[] { HouseName.House8, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse8)]
        public static CalculatorResult MoonInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 8), new[] { HouseName.House8, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse8)]
        public static CalculatorResult MarsInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 8), new[] { HouseName.House8, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse8)]
        public static CalculatorResult MercuryInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 8), new[] { HouseName.House8, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse8)]
        public static CalculatorResult JupiterInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 8), new[] { HouseName.House8, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse8)]
        public static CalculatorResult VenusInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 8), new[] { HouseName.House8, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse8)]
        public static CalculatorResult SaturnInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 8), new[] { HouseName.House8, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse8)]
        public static CalculatorResult RahuInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 8), new[] { HouseName.House8, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse8)]
        public static CalculatorResult KetuInHouse8Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 8), new[] { HouseName.House8, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 9), new[] { HouseName.House9, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse9)]
        public static CalculatorResult MoonInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 9), new[] { HouseName.House9, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse9)]
        public static CalculatorResult MarsInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 9), new[] { HouseName.House9, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse9)]
        public static CalculatorResult MercuryInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 9), new[] { HouseName.House9, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse9)]
        public static CalculatorResult JupiterInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 9), new[] { HouseName.House9, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse9)]
        public static CalculatorResult VenusInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 9), new[] { HouseName.House9, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse9)]
        public static CalculatorResult SaturnInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 9), new[] { HouseName.House9, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse9)]
        public static CalculatorResult RahuInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 9), new[] { HouseName.House9, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse9)]
        public static CalculatorResult KetuInHouse9Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 9), new[] { HouseName.House9, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 10), new[] { HouseName.House10, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse10)]
        public static CalculatorResult MoonInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 10), new[] { HouseName.House10, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse10)]
        public static CalculatorResult MarsInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 10), new[] { HouseName.House10, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse10)]
        public static CalculatorResult MercuryInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 10), new[] { HouseName.House10, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse10)]
        public static CalculatorResult JupiterInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 10), new[] { HouseName.House10, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse10)]
        public static CalculatorResult VenusInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 10), new[] { HouseName.House10, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse10)]
        public static CalculatorResult SaturnInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 10), new[] { HouseName.House10, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse10)]
        public static CalculatorResult RahuInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 10), new[] { HouseName.House10, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse10)]
        public static CalculatorResult KetuInHouse10Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 10), new[] { HouseName.House10, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 11), new[] { HouseName.House11, }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse11)]
        public static CalculatorResult MoonInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 11), new[] { HouseName.House11, }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse11)]
        public static CalculatorResult MarsInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 11), new[] { HouseName.House11, }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse11)]
        public static CalculatorResult MercuryInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 11), new[] { HouseName.House11, }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse11)]
        public static CalculatorResult JupiterInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 11), new[] { HouseName.House11, }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse11)]
        public static CalculatorResult VenusInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 11), new[] { HouseName.House11, }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse11)]
        public static CalculatorResult SaturnInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 11), new[] { HouseName.House11, }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse11)]
        public static CalculatorResult RahuInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 11), new[] { HouseName.House11, }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse11)]
        public static CalculatorResult KetuInHouse11Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 11), new[] { HouseName.House11, }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult SunInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 12), new[] { HouseName.House12 }, new[] { PlanetName.Sun }, time);

        [HoroscopeCalculator(HoroscopeName.MoonInHouse12)]
        public static CalculatorResult MoonInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Moon, 12), new[] { HouseName.House12 }, new[] { PlanetName.Moon }, time);

        [HoroscopeCalculator(HoroscopeName.MarsInHouse12)]
        public static CalculatorResult MarsInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 12), new[] { HouseName.House12 }, new[] { PlanetName.Mars }, time);

        [HoroscopeCalculator(HoroscopeName.MercuryInHouse12)]
        public static CalculatorResult MercuryInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 12), new[] { HouseName.House12 }, new[] { PlanetName.Mercury }, time);

        [HoroscopeCalculator(HoroscopeName.JupiterInHouse12)]
        public static CalculatorResult JupiterInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 12), new[] { HouseName.House12 }, new[] { PlanetName.Jupiter }, time);

        [HoroscopeCalculator(HoroscopeName.VenusInHouse12)]
        public static CalculatorResult VenusInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 12), new[] { HouseName.House12 }, new[] { PlanetName.Venus }, time);

        [HoroscopeCalculator(HoroscopeName.SaturnInHouse12)]
        public static CalculatorResult SaturnInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 12), new[] { HouseName.House12 }, new[] { PlanetName.Saturn }, time);

        [HoroscopeCalculator(HoroscopeName.RahuInHouse12)]
        public static CalculatorResult RahuInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Rahu, 12), new[] { HouseName.House12 }, new[] { PlanetName.Rahu }, time);

        [HoroscopeCalculator(HoroscopeName.KetuInHouse12)]
        public static CalculatorResult KetuInHouse12Occuring(Time time) => CalculatorResult.New(AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Ketu, 12), new[] { HouseName.House12 }, new[] { PlanetName.Ketu }, time);
        ...
        public static CalculatorResult MarsVenusIn7th(Time time)
        {
            ...
            var marsIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 7);

            //venus in 7th at birth
            var venusIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 7);
        ...
        public static CalculatorResult MercuryOrJupiterIn7th(Time time)
        {
            ...
            var mercuryIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mercury, 7);

            //Jupiter in 7th at birth
            var jupiterIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Jupiter, 7);
        ...
        public static CalculatorResult LeoLagna7thLordSaturnIn2(Time time)
        {
            ...
            //lagna is leo
            var leoIsLagna = AstronomicalCalculator.GetHouseSignName(1, time) == ZodiacName.Leo;
            ...
            //is saturn in 2nd
            var isSaturnIn2nd =
                AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 2);
        ...
        public static CalculatorResult SaturnIn7thNotLagnaLord(Time time)
        {
            ...
            var isSaturnIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Saturn, 7);
        ...
        public static CalculatorResult MarsIn7thNoBenefics(Time time)
        {
            ...
            var isMarsIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Mars, 7);
            ...
            var beneficNotFoundIn7th = !AstronomicalCalculator.IsBeneficPlanetInHouse(7, time);
        ...
        public static CalculatorResult SunVenusIn5th7th9th(Time time)
        {
            ...
            //is sun & venus in 5th
            var isSunIn5th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 5);
            var isVenusIn5th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 5);
            var sunAndVenusIn5th = isSunIn5th && isVenusIn5th;

            //is sun & venus in 7th
            var isSunIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 7);
            var isVenusIn7th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 7);
            var sunAndVenusIn7th = isSunIn7th && isVenusIn7th;

            //is sun & venus in 9th
            var isSunIn9th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Sun, 9);
            var isVenusIn9th = AstronomicalCalculator.IsPlanetInHouse(time, PlanetName.Venus, 9);
